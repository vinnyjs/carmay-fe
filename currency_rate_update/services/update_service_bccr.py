...
class BCCRGetter(CurrencyGetterInterface):
    ...
    def get_updated_currency(self, currency_array, main_currency,
        ...
        url1 = 'https://gee.bccr.fi.cr/Indicadores/Suscripciones/WS/wsindicadoreseconomicos.asmx/ObtenerIndicadoresEconomicosXML?Indicador=318&FechaInicio=' + today + '&FechaFinal=' + today + '&Nombre=OSS&SubNiveles=N&CorreoElectronico=bryanjs@outlook.es&Token=J072NAA0RR'
        url2 = '&tcIndicador='
        ...
        for curr in currency_array:
            ...
            for node in nodes:
                node = parseString(node.toprettyxml().replace('&gt;', '>').replace('&lt;', '<'))
