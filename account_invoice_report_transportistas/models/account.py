...
class AccountInvoice(models.Model):
    ...
    def _compute_amount_inherit(self):
        ...
        self.amount_total_discount = sum((line.price_unit - line.price_with_discount) for line in self.invoice_line_ids)
    ...
    def espaces(self):
        ...
        for l in self.invoice_line_ids:
            length = len(l.name)
            result = (length > 29 and (len(l.name) / 29.0) or 1.0)
    ...
    def invoice_print_inherit(self):
        ...
        return self.env['report'].get_action(self, 'account_invoice_report_transportistas.report_account_invoice_facturaelectronica')
