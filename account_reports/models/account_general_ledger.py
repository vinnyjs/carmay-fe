...
class report_account_general_ledger(models.AbstractModel):
    ...
    def get_lines(self, context_id, line_id=None):
        ...
        new_context.update({
            ...
            'analytic_tag_ids1': context_id.analytic_tag_ids,
        })
    ...
    def _lines(self, line_id=None):
        ...
        for account in sorted_accounts:
            ...
            inicial = grouped_accounts[account]['initial_bal']['balance']
            ...
            lines.append({
                ...
                'columns': [self._format(initial_balance), self._format(debit-initial_debit), self._format(credit-initial_credit), self._format(balance)],#bryan aqui
                'level': 2,
                'unfoldable': True,
...
class account_context_general_ledger(models.TransientModel):
    ...
    def get_columns_names(self):
        return [_("Date"), _("Communication"), _("Partner"), _("Saldo Inicial"), _("Debit"), _("Credit"), _("Balance")]
